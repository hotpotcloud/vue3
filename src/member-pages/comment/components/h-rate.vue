    ...
    <view ref="uni-rate" class="uni-rate">
      ...
      >
        ...
        <u-icon
          ...
          :width="size"
          :height="size"
          :name="isFill ? iconsNo : iconsActive"
        />
        <!-- #ifdef APP-NVUE -->
        <view
          :style="{
...
export default {
  ...
  data() {
    return {
      iconsActive:
        "https://freshgo-prd-1302811166.cos.ap-chengdu.myqcloud.com/fhgo-miniprogram/commonSource/start1.png",
      iconsNo:
        "https://freshgo-prd-1302811166.cos.ap-chengdu.myqcloud.com/fhgo-miniprogram/commonSource/start0.png",
      valueSync: "",
